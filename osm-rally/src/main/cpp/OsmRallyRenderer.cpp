...
// Ctor
//--------------------------------------------------------------------------------
OsmRallyRenderer::OsmRallyRenderer() {}

//--------------------------------------------------------------------------------
// Dtor
//--------------------------------------------------------------------------------
OsmRallyRenderer::~OsmRallyRenderer() { Unload(); }

void OsmRallyRenderer::Init() {
  // Settings
  glFrontFace(GL_CCW);
...
void OsmRallyRenderer::UpdateViewport() {
...
void OsmRallyRenderer::Update(float fTime) {
...
bool OsmRallyRenderer::LoadShaders(SHADER_PARAMS* params, const char* strVsh,
                                 const char* strFsh) {
  GLuint program;
...
bool OsmRallyRenderer::Bind(ndk_helper::TapCamera* camera) {
  camera_ = camera;
  return true;
}
